    ...
    <main className="fixed inset-0 w-full h-full bg-[var(--bg-void)] overflow-hidden">
        ...
        {showSplash && (
          ...
          >
            ...
            <div className="absolute inset-0 pointer-events-none z-[1]" style={{
              backgroundImage: 'repeating-linear-gradient(0deg, transparent, transparent 2px, rgba(167, 234, 237,0.015) 2px, rgba(167, 234, 237,0.015) 4px)',
            ...
            <div className="relative w-40 h-40 mb-8 flex items-center justify-center z-[2]">
              ...
              <motion.div
                ...
                style={{ border: '1px solid rgba(167, 234, 237,0.2)' }}
              >
                <div className="absolute top-0 left-1/2 -translate-x-1/2 -translate-y-1/2 w-2 h-2 rounded-full" style={{ background: 'var(--gold-primary)', boxShadow: '0 0 12px var(--gold-primary), 0 0 24px rgba(167, 234, 237,0.3)' }} />
                <div className="absolute bottom-0 left-1/2 -translate-x-1/2 translate-y-1/2 w-1 h-1 rounded-full" style={{ background: 'rgba(167, 234, 237,0.5)', boxShadow: '0 0 6px rgba(167, 234, 237,0.3)' }} />
              </motion.div>
              ...
              <motion.div
                ...
                style={{ inset: '18px', border: '1px solid rgba(74, 158, 224,0.15)' }}
              >
                <div className="absolute top-1/2 right-0 translate-x-1/2 -translate-y-1/2 w-1.5 h-1.5 rounded-full" style={{ background: 'var(--cyan-primary)', boxShadow: '0 0 10px var(--cyan-primary), 0 0 20px rgba(74, 158, 224,0.2)' }} />
                <div className="absolute bottom-0 left-1/4 translate-y-1/2 w-1 h-1 rounded-full" style={{ background: 'rgba(74, 158, 224,0.4)' }} />
              </motion.div>
              ...
              <motion.div
                ...
                className="absolute rounded-full"
                style={{ inset: '40px', border: '1px solid rgba(167, 234, 237,0.25)' }}
              >
              ...
              <motion.div
                ...
                style={{ border: '2px solid var(--gold-primary)', boxShadow: '0 0 20px rgba(167, 234, 237,0.15), inset 0 0 20px rgba(167, 234, 237,0.05)' }}
              >
                <motion.div
                  animate={{ opacity: [0.3, 0.8, 0.3] }}
                  transition={{ duration: 2, repeat: Infinity, ease: 'easeInOut' }}
                  className="w-5 h-5 rounded-full"
                  style={{ background: 'radial-gradient(circle, rgba(167, 234, 237,0.4) 0%, rgba(167, 234, 237,0.05) 70%)' }}
                />
                {/* Crosshair lines */}
                <div className="absolute w-[1px] h-full" style={{ background: 'linear-gradient(to bottom, transparent, rgba(167, 234, 237,0.3), transparent)' }} />
                <div className="absolute w-full h-[1px]" style={{ background: 'linear-gradient(to right, transparent, rgba(167, 234, 237,0.3), transparent)' }} />
              </motion.div>
              ...
              <motion.div
                ...
                style={{ background: 'conic-gradient(from 0deg, transparent 0deg, rgba(167, 234, 237,0.15) 40deg, transparent 80deg)' }}
              />
            </div>
            ...
            <div className="flex items-center gap-[2px] mb-3 z-[2]">
              {'OSIRIS'.split('').map((letter, i) => (
                <motion.span
                  ...
                  style={{ fontFamily: 'var(--font-display)', color: 'var(--text-heading)', textShadow: '0 0 30px rgba(167, 234, 237,0.2)' }}
                >
                  {letter}
                </motion.span>
              ))}
            ...
            <div className="w-64 md:w-80 z-[2]">
              {/* Thin progress track */}
              <div className="relative w-full h-[2px] rounded-full overflow-hidden" style={{ background: 'rgba(167, 234, 237,0.1)' }}>
                <motion.div
                  initial={{ width: '0%' }}
                  animate={{ width: ['0%', '25%', '50%', '78%', '100%'] }}
                  transition={{ duration: 2.2, delay: 0.5, times: [0, 0.25, 0.5, 0.75, 1], ease: 'easeInOut' }}
                  className="absolute inset-y-0 left-0 rounded-full"
                  style={{ background: 'linear-gradient(90deg, var(--gold-primary), var(--cyan-primary), var(--gold-primary))', boxShadow: '0 0 12px rgba(167, 234, 237,0.4)' }}
                />
              </div>
            ...
            <div className="absolute inset-0 pointer-events-none z-[0]" style={{ opacity: 0.03 }}>
              <div className="absolute inset-0" style={{
                backgroundImage: 'linear-gradient(rgba(167, 234, 237,0.5) 1px, transparent 1px), linear-gradient(90deg, rgba(167, 234, 237,0.5) 1px, transparent 1px)',
      ...
      <motion.div initial={{ opacity: 0, y: -20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 1, delay: 2.5 }} className={`absolute top-4 z-[200] pointer-events-none flex flex-col`} style={{ left: isMobile ? '24px' : '64px', right: '24px' }}>
        <div className="flex items-center gap-3 w-fit">
          <svg viewBox="0 0 48 48" className="w-8 h-8 md:w-10 md:h-10 shrink-0 transition-colors duration-500 drop-shadow-[0_0_8px_rgba(167,234,237,0.5)]" aria-label="Peak Automation">
            {/* Secondary ridge */}
          ...
          <div className="flex flex-col items-start gap-0.5">
            <h1 className="text-lg md:text-xl font-bold tracking-[0.4em] text-[var(--gold-primary)]" style={{ fontFamily: 'var(--font-display)' }}>OSIRIS</h1>
            <span className="text-[8px] md:text-[9px] font-mono tracking-[0.2em] opacity-80 uppercase text-[var(--gold-primary)]">By Peak Automation</span>
          </div>
        </div>
      ...
      <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 3 }} className="status-bar-desktop absolute top-4 right-6 z-[200] pointer-events-none flex items-center gap-3 text-[9px] font-mono tracking-widest text-[var(--text-muted)]">
        ...
        <a href='https://peakautomation.ca' target='_blank' rel='noopener noreferrer' className="pointer-events-auto glass-panel px-3 py-1.5 flex items-center gap-1.5 text-[8px] font-mono tracking-widest hover:opacity-80 transition-opacity border-[var(--gold-primary)]/40 bg-[var(--gold-primary)]/10 ml-3 shadow-[0_0_10px_rgba(167,234,237,0.1)]">
          <div className="w-1.5 h-1.5 rounded-full bg-[var(--gold-primary)] animate-osiris-pulse" />
          <span className="text-[var(--gold-primary)] font-bold">PEAK AUTOMATION</span>
        </a>
      </motion.div>
      ...
      {isMobile && (
        <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 2.5 }} className="absolute top-3 right-3 z-[200] pointer-events-auto flex items-center gap-2">
          <a href='https://peakautomation.ca' target='_blank' rel='noopener noreferrer' className="glass-panel px-2 py-1 flex items-center gap-1.5 text-[7px] font-mono tracking-widest hover:opacity-80 transition-opacity border-[var(--gold-primary)]/40 bg-[var(--gold-primary)]/10">
            <div className="w-1 h-1 rounded-full bg-[var(--gold-primary)] animate-osiris-pulse" />
            <span className="text-[var(--gold-primary)] font-bold">PEAK</span>
          </a>
        </motion.div>
      )}
      ...
      {!isMobile && <div className="absolute right-2 top-1/2 -translate-y-1/2 flex flex-col gap-2 z-[250] pointer-events-auto bg-black/40 backdrop-blur-sm p-1 rounded-full border border-white/5">
        ...
        <div className="relative group">
          <button onClick={() => { setShowMarkets(!showMarkets); setShowIntel(false); setShowAlerts(false); }} className={`w-8 h-8 rounded-full flex items-center justify-center transition-colors ${showMarkets ? 'bg-[var(--gold-primary)]/20' : 'hover:bg-white/10'}`} title="Markets — defense stocks, commodities, global indices">
        ...
        <div className="relative group">
          <button onClick={() => { setShowEntityGraph(!showEntityGraph); setShowIntel(false); setShowMarkets(false); setShowAlerts(false); }} className={`w-8 h-8 rounded-full flex items-center justify-center transition-colors ${showEntityGraph ? 'bg-[#A7EAED]/20' : 'hover:bg-white/10'}`} title="Entity Graph — link analysis between tracked entities">
            ...
            {showArcGIS && (
              <motion.div initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0 }} exit={{ opacity: 0, x: 20 }} className="absolute right-12 top-1/2 -translate-y-1/2 w-[340px]">
                <div className="glass-panel p-3 max-h-[70vh] overflow-y-auto styled-scrollbar">
                  <ArcGISPanel
                    onImportLayer={(layer) => setArcgisLayers(prev => [...prev.filter(l => l.id !== layer.id), { ...layer, color: layer.color || '#A7EAED', visible: true, opacity: layer.opacity ?? 0.8 }])}
