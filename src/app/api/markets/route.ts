 ...
 * Defense stocks, oil, gold, silver, natural gas, wheat, indices
...
export async function GET() {
  try {
    ...
    const [stockResults, oilResults, commodityResults, indexResults] = await Promise.all([
    ...
    return NextResponse.json({
      stocks, oil, commodities, indices, scm_alerts,
    ...
    return NextResponse.json({ stocks: {}, oil: {}, commodities: {}, indices: {}, scm_alerts: [], error: 'Failed' }, { status: 500 });
  }
}
